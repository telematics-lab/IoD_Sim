...
public:
  ...
  static const std::vector<ModelConfiguration::Attribute> GetAttributes (const TypeId& model, const JsonArray& jAttrs);

private:
  ModelConfigurationHelper ();
  static const ModelConfiguration::Attribute DecodeModelAttribute (const TypeId& model, const JsonValue& jAttr);
};
