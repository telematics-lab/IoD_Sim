...
Scenario::ConfigurePhy ()
{
  ...
  // WIP: get propagation loss model from file and set it up
  // TODO: Need a more sophisticated/general API to cover ALL propagation loss models
  ...
  const auto propagationLossAttr = CONFIGURATOR->GetThreeLogDistancePropagationLossModelAttributes();

  wifiChannel.AddPropagationLoss (propagationLossModel,
    propagationLossAttr[0].first, DoubleValue (propagationLossAttr[0].second),
    propagationLossAttr[1].first, DoubleValue (propagationLossAttr[1].second),
    propagationLossAttr[2].first, DoubleValue (propagationLossAttr[2].second),
    propagationLossAttr[3].first, DoubleValue (propagationLossAttr[3].second),
    propagationLossAttr[4].first, DoubleValue (propagationLossAttr[4].second),
    propagationLossAttr[5].first, DoubleValue (propagationLossAttr[5].second),
    propagationLossAttr[6].first, DoubleValue (propagationLossAttr[6].second),
    propagationLossAttr[7].first, DoubleValue (propagationLossAttr[7].second));
