...
{
  static TypeId tid = TypeId ("ns3::TcpClientServerApplication")
    .SetParent<Application> ()
    .SetGroupName ("Applications")
    .AddConstructor<TcpClientServerApplication> ()
    .AddAttribute ("Address", "Remote/Listening IP Address.",
                   Ipv4AddressValue (Ipv4Address::GetLoopback ()),
                   MakeIpv4AddressAccessor (&TcpClientServerApplication::m_addr),
                   MakeIpv4AddressChecker ())
    .AddAttribute ("Port", "Remote/Listening port.",
                   UintegerValue (4242),
                   MakeUintegerAccessor (&TcpClientServerApplication::m_port),
                   MakeUintegerChecker<uint16_t> ())
    .AddTraceSource ("ConnectionEstablished", "A new connection has been established.",
    ...
    .AddTraceSource ("ConnectionClosed", "A connection has been closed successfully.",
...
TcpClientServerApplication::StartApplication ()
{
  ...
  m_socket->SetAcceptCallback  (MakeCallback (&TcpClientServerApplication::ConnectionRequestCallback, this),
                                MakeCallback (&TcpClientServerApplication::ConnectionEstablishedCallback, this));
  m_socket->SetConnectCallback (MakeCallback (&TcpClientServerApplication::ConnectionSucceededCallback, this),
                                MakeCallback (&TcpClientServerApplication::ConnectionFailedCallback, this));
  m_socket->SetCloseCallbacks  (MakeCallback (&TcpClientServerApplication::NormalCloseCallback, this),
                                MakeCallback (&TcpClientServerApplication::ErrorCloseCallback, this));
  // m_socket->SetRecvCallback    (MakeCallback (&TcpClientServerApplication::ReceivedDataCallback, this));
