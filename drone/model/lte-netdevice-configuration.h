...
public:
   ...
   * \param rawRole The role of the network device in the LTE RAN (e.g., UE or eNB).
   *                This string will be parsed in the correct role.
   * \param bearers The bearers to be initialised for this network device.
