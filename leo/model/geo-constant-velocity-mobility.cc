...
GeoConstantVelocityMobility::GetTypeId ()
{
  return TypeId ("ns3::GeoConstantVelocityMobility")
    ...
    .AddAttribute ("InitialLatitude",
        ...
        DoubleValue (0.0),
        MakeDoubleAccessor (&GeoConstantVelocityMobility::m_initialLatitude),
        MakeDoubleChecker<double> (-90.0, 90.0))
    .AddAttribute ("InitialLongitude",
        "Initial longitude position in degrees",
        DoubleValue (0.0),
        MakeDoubleAccessor (&GeoConstantVelocityMobility::m_initialLongitude),
...
{
  return CartesianToTopocentric (DoGetGeocentricVelocity(), GetGeographicReferencePoint(), GeographicPositions::SPHERE);
}
