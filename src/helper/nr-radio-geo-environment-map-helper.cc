...
NS_LOG_COMPONENT_DEFINE("NrRadioGeoEnvironmentMapHelper");

NS_OBJECT_ENSURE_REGISTERED(NrRadioGeoEnvironmentMapHelper);

NrRadioGeoEnvironmentMapHelper::NrRadioGeoEnvironmentMapHelper()
{
...
void
NrRadioGeoEnvironmentMapHelper::DoDispose()
{
    NS_LOG_FUNCTION(this);
}

TypeId
NrRadioGeoEnvironmentMapHelper::GetTypeId()
{
    NS_LOG_FUNCTION("NrRadioGeoEnvironmentMapHelper::GetTypeId");
    static TypeId tid =
        TypeId("ns3::NrRadioGeoEnvironmentMapHelper")
            .SetParent<Object>()
            .SetGroupName("Nr")
            .AddConstructor<NrRadioGeoEnvironmentMapHelper>()
            .AddAttribute("SimTag",
                          ...
                          StringValue(""),
                          MakeStringAccessor(&NrRadioGeoEnvironmentMapHelper::SetSimTag),
                          MakeStringChecker())
            .AddAttribute("MinLon",
                          "The min longitude of the map.",
                          DoubleValue(0.0),
                          MakeDoubleAccessor(&NrRadioGeoEnvironmentMapHelper::SetMinLon,
                                             &NrRadioGeoEnvironmentMapHelper::GetMinLon),
                          MakeDoubleChecker<double>())
            .AddAttribute("MinLat",
                          "The min latitude of the map.",
                          DoubleValue(0.0),
                          MakeDoubleAccessor(&NrRadioGeoEnvironmentMapHelper::SetMinLat,
                                             &NrRadioGeoEnvironmentMapHelper::GetMinLat),
                          MakeDoubleChecker<double>())
            .AddAttribute("MaxLon",
                          "The max longitude of the map.",
                          DoubleValue(0.0),
                          MakeDoubleAccessor(&NrRadioGeoEnvironmentMapHelper::SetMaxLon,
                                             &NrRadioGeoEnvironmentMapHelper::GetMaxLon),
                          MakeDoubleChecker<double>())
            .AddAttribute("MaxLat",
                          "The max latitude of the map.",
                          DoubleValue(0.0),
                          MakeDoubleAccessor(&NrRadioGeoEnvironmentMapHelper::SetMaxLat,
                                             &NrRadioGeoEnvironmentMapHelper::GetMaxLat),
                          MakeDoubleChecker<double>())
            .AddAttribute("XRes",
                          "The resolution (number of points) of the"
                          "map along the longitude.",
                          UintegerValue(100),
                          MakeUintegerAccessor(&NrRadioGeoEnvironmentMapHelper::SetResX,
                                               &NrRadioGeoEnvironmentMapHelper::GetResX),
                          MakeUintegerChecker<uint32_t>(2, std::numeric_limits<uint16_t>::max()))
            .AddAttribute("YRes",
                          "The resolution (number of points) of the"
                          "map along the latitude.",
                          UintegerValue(100),
                          MakeUintegerAccessor(&NrRadioGeoEnvironmentMapHelper::SetResY,
                                               &NrRadioGeoEnvironmentMapHelper::GetResY),
                          MakeUintegerChecker<uint16_t>(2, std::numeric_limits<uint16_t>::max()))
            .AddAttribute("Altitude",
                          "The value of the altitude for which"
                          "the map is to be generated.",
                          DoubleValue(1.5),
                          MakeDoubleAccessor(&NrRadioGeoEnvironmentMapHelper::SetAltitude,
                                             &NrRadioGeoEnvironmentMapHelper::GetAltitude),
                          MakeDoubleChecker<double>())
            .AddAttribute(
                "IterForAverage",
                ...
                UintegerValue(1),
                MakeUintegerAccessor(&NrRadioGeoEnvironmentMapHelper::SetNumOfItToAverage),
                //&NrRadioGeoEnvironmentMapHelper::GetMaxPointsPerIt),
            ...
            .AddAttribute(
                ...
                EnumValue(NrRadioGeoEnvironmentMapHelper::COVERAGE_AREA),
                MakeEnumAccessor<RemMode>(&NrRadioGeoEnvironmentMapHelper::SetRemMode,
                                          &NrRadioGeoEnvironmentMapHelper::GetRemMode),
                MakeEnumChecker(NrRadioGeoEnvironmentMapHelper::BEAM_SHAPE,
                                "BeamShape",
                                NrRadioGeoEnvironmentMapHelper::COVERAGE_AREA,
                                "CoverageArea",
                                NrRadioGeoEnvironmentMapHelper::UE_COVERAGE,
                                "UeCoverageArea"))
            .AddAttribute(
                "InstallationDelay",
                ...
                MakeTimeAccessor(&NrRadioGeoEnvironmentMapHelper::SetInstallationDelay),
                MakeTimeChecker())
            .AddAttribute("LogGeocentricRem",
                          "If true, the geocentric REM (ECEF coordinates) will be saved to a file.",
                          BooleanValue(false),
...
void
NrRadioGeoEnvironmentMapHelper::SetRemMode(enum RemMode remMode)
{
    m_remMode = remMode;
}

void
NrRadioGeoEnvironmentMapHelper::SetSimTag(const std::string& simTag)
{
    m_simTag = simTag;
}

void
NrRadioGeoEnvironmentMapHelper::SetMinLon(double minLon)
{
    m_minLon = minLon;
}

void
NrRadioGeoEnvironmentMapHelper::SetMinLat(double minLat)
{
    m_minLat = minLat;
}

void
NrRadioGeoEnvironmentMapHelper::SetMaxLon(double maxLon)
{
    m_maxLon = maxLon;
}

void
NrRadioGeoEnvironmentMapHelper::SetMaxLat(double maxLat)
{
    m_maxLat = maxLat;
}

void
NrRadioGeoEnvironmentMapHelper::SetResX(uint16_t xRes)
{
    m_xRes = xRes;
}

void
NrRadioGeoEnvironmentMapHelper::SetResY(uint16_t yRes)
{
    m_yRes = yRes;
}

void
NrRadioGeoEnvironmentMapHelper::SetAltitude(double altitude)
{
    m_altitude = altitude;
}

void
NrRadioGeoEnvironmentMapHelper::SetNumOfItToAverage(uint16_t numOfIterationsToAverage)
{
    m_numOfIterationsToAverage = numOfIterationsToAverage;
}

void
NrRadioGeoEnvironmentMapHelper::SetInstallationDelay(const Time& installationDelay)
{
    m_installationDelay = installationDelay;
}

void
NrRadioGeoEnvironmentMapHelper::SetLogGeocentricRem(bool logGeocentricRem)
{
...
NrRadioGeoEnvironmentMapHelper::GetRemMode() const
{
    return m_remMode;
}

double
NrRadioGeoEnvironmentMapHelper::GetMinLon() const
{
    return m_minLon;
}

double
NrRadioGeoEnvironmentMapHelper::GetMinLat() const
{
    return m_minLat;
}

double
NrRadioGeoEnvironmentMapHelper::GetMaxLon() const
{
    return m_maxLon;
}

double
NrRadioGeoEnvironmentMapHelper::GetMaxLat() const
{
    return m_maxLat;
}

uint16_t
NrRadioGeoEnvironmentMapHelper::GetResX() const
{
    return m_xRes;
}

uint16_t
NrRadioGeoEnvironmentMapHelper::GetResY() const
{
    return m_yRes;
}

double
NrRadioGeoEnvironmentMapHelper::GetAltitude() const
{
    return m_altitude;
}

double
NrRadioGeoEnvironmentMapHelper::DbmToW(double dBm) const
{
    return std::pow(10.0, 0.1 * (dBm - 30.0));
}

double
NrRadioGeoEnvironmentMapHelper::WToDbm(double w) const
{
    return 10.0 * std::log10(w) + 30.0;
}

double
NrRadioGeoEnvironmentMapHelper::DbToRatio(double dB) const
{
    return std::pow(10.0, 0.1 * dB);
}

double
NrRadioGeoEnvironmentMapHelper::RatioToDb(double ratio) const
{
    return 10.0 * std::log10(ratio);
}

void
NrRadioGeoEnvironmentMapHelper::ConfigureRrd(const Ptr<NetDevice>& rrdDevice)
{
    NS_LOG_FUNCTION(this);
    ...
    Vector rrdPosEcef = geocentricMobility->GetPosition(PositionType::GEOCENTRIC);
    m_rrd.mob->SetPosition(rrdPosEcef, PositionType::GEOCENTRIC);
...
void
NrRadioGeoEnvironmentMapHelper::ConfigureRtdList(const NetDeviceContainer& rtdDevs)
{
    NS_LOG_FUNCTION(this);
         ...
         ++netDevIt)
    {
        ...
        Vector rtdPosEcef = geocentricMobility->GetPosition(PositionType::GEOCENTRIC);
        rtd.mob->SetPosition(rtdPosEcef, PositionType::GEOCENTRIC);
        Ptr<MobilityBuildingInfo> buildingInfo = CreateObject<MobilityBuildingInfo>();
...
void
NrRadioGeoEnvironmentMapHelper::ConfigurePropagationModelsFactories(const Ptr<const NrPhy>& rtdPhy)
{
    NS_LOG_FUNCTION(this);
...
void
NrRadioGeoEnvironmentMapHelper::CreateRem(const NetDeviceContainer& rtdNetDev,
                                          ...
                                          uint8_t bwpId)
{
    ...
    Simulator::Schedule(m_installationDelay,
                        &NrRadioGeoEnvironmentMapHelper::DelayedInstall,
                        this,
                        rtdNetDev,
                        rrdDevice);
}
...
void
NrRadioGeoEnvironmentMapHelper::SaveAntennasWithUserDefinedBeams(
...
void
NrRadioGeoEnvironmentMapHelper::DelayedInstall(const NetDeviceContainer& rtdNetDev,
                                               const Ptr<NetDevice>& rrdDevice)
{
    NS_LOG_FUNCTION(this);
...
void
NrRadioGeoEnvironmentMapHelper::CreateListOfRemPoints()
{
    NS_LOG_FUNCTION(this);

    // Create the list of the REM Points

    m_lonStep = (m_maxLon - m_minLon) / (m_xRes);
    m_latStep = (m_maxLat - m_minLat) / (m_yRes);

    NS_ASSERT_MSG(m_maxLon > m_minLon, "MaxLon must be higher than MinLon");
    NS_ASSERT_MSG(m_maxLat > m_minLat, "MaxLat must be higher than MinLat");
    NS_ASSERT_MSG(m_xRes != 0 || m_yRes != 0, "Resolution must be higher than 0");

    NS_LOG_INFO("m_lonStep: " << m_lonStep << " m_latStep: " << m_latStep);

    for (double lon = m_minLon; lon < m_maxLon + 0.5 * m_lonStep; lon += m_lonStep)
    {
        for (double lat = m_minLat; lat < m_maxLat + 0.5 * m_latStep; lat += m_latStep)
        {
            // Calculate Cartesian position (ECEF) from Lat/Lon/Alt
            // Assuming SPHERE model as set in main.cc
            Vector pos =
                GeographicPositions::GeographicToCartesianCoordinates(lat,
                                                                      lon,
                                                                      m_altitude,
...
Ptr<SpectrumValue>
NrRadioGeoEnvironmentMapHelper::CalcRxPsdValue(RemDevice& device, RemDevice& otherDevice) const
{
...
Ptr<SpectrumValue>
NrRadioGeoEnvironmentMapHelper::GetMaxValue(const std::list<Ptr<SpectrumValue>>& values) const
{
...
double
NrRadioGeoEnvironmentMapHelper::CalculateMaxSnr(
...
double
NrRadioGeoEnvironmentMapHelper::CalculateSnr(const Ptr<SpectrumValue>& usefulSignal) const
{
...
NrRadioGeoEnvironmentMapHelper::SetInterferers(const NetDeviceContainer& interferers, uint8_t bwpId)
{
    ...
    for (auto it = interferers.Begin(); it != interferers.End(); ++it)
    {
        ...
        Ptr<NrGnbNetDevice> gnb = DynamicCast<NrGnbNetDevice>(dev);
        if (gnb)
        {
            phy = gnb->GetPhy(bwpId);
        }
        else
        {
        ...
        remDev.mob = remDev.node->GetObject<GeocentricMobilityModel>();
        remDev.spectrumModel = phy->GetSpectrumModel();
        remDev.txPower = phy->GetTxPower();
        ...
        if (remDev.mob)
        {
            // We do not copy the position here; we rely on the live mobility model
            // because GetSinr is instantaneous.
            m_remDev.push_back(remDev);
        }
    }
}

double
NrRadioGeoEnvironmentMapHelper::GetSinr(Ptr<NetDevice> ueDevice,
                                        ...
                                        bool isDl)
{
    ...
    {
        NS_FATAL_ERROR("GetSinr expects an NrUeNetDevice and an NrGnbNetDevice.");
    }
    ...
    for (auto& intDev : m_remDev)
    {
        // Avoid self-interference
        if (intDev.node == txDevice.node)
        {
            continue;
        }
...
double
NrRadioGeoEnvironmentMapHelper::CalculateSinr(
    ...
    const std::list<Ptr<SpectrumValue>>& interferenceSignals) const
{
    ...
    {
        interferencePsd = Create<SpectrumValue>(usefulSignal->GetSpectrumModel());
    }
...
double
NrRadioGeoEnvironmentMapHelper::CalculateSir(
    const Ptr<SpectrumValue>& usefulSignal,
    const std::list<Ptr<SpectrumValue>>& interferenceSignals) const
{
    Ptr<SpectrumValue> interferencePsd = nullptr;
...
double
NrRadioGeoEnvironmentMapHelper::CalculateMaxSinr(
    const std::list<Ptr<SpectrumValue>>& receivedPowerList) const
{
...
double
NrRadioGeoEnvironmentMapHelper::CalculateMaxSir(
    const std::list<Ptr<SpectrumValue>>& receivedPowerList) const
{
    // we calculate sinr considering for each RTD as if it would be TX device, and the rest of RTDs
    // interferers
...
void
NrRadioGeoEnvironmentMapHelper::CalcBeamShapeRemMap()
{
    NS_LOG_FUNCTION(this);
         ...
         ++itRemPoint)
    {
        ...
        // Use ECEF directly with GeocentricMobilityModel
        m_rrd.mob->SetPosition(itRemPoint->pos, PositionType::GEOCENTRIC);
...
double
NrRadioGeoEnvironmentMapHelper::GetMaxValue(const std::list<double>& listOfValues) const
{
...
double
NrRadioGeoEnvironmentMapHelper::CalculateAggregatedIpsd(
...
double
NrRadioGeoEnvironmentMapHelper::SumListElements(const std::list<double>& listOfValues)
{
    NS_ABORT_MSG_IF(listOfValues.empty(),
...
void
NrRadioGeoEnvironmentMapHelper::CalcCoverageAreaRemMap()
{
    NS_LOG_FUNCTION(this);
...
void
NrRadioGeoEnvironmentMapHelper::PrintProgressReport(uint32_t* remSizeNextReport)
{
...
void
NrRadioGeoEnvironmentMapHelper::CalcUeCoverageRemMap()
{
    NS_LOG_FUNCTION(this);
...
NrRadioGeoEnvironmentMapHelper::PropagationModels
NrRadioGeoEnvironmentMapHelper::CreateTemporalPropagationModels() const
{
    NS_LOG_FUNCTION(this);
...
void
NrRadioGeoEnvironmentMapHelper::PrintGnuplottableUeListToFile(const std::string& filename)
{
    NS_LOG_FUNCTION(this);
...
void
NrRadioGeoEnvironmentMapHelper::PrintGnuplottableBuildingListToFile(const std::string& filename)
{
    NS_LOG_FUNCTION(this);
...
void
NrRadioGeoEnvironmentMapHelper::PrintRemToFile()
{
    NS_LOG_FUNCTION(this);
    ...
    for (auto& it : m_rem)
    {
        // Convert back to Geo for printing: X=Lat, Y=Lon, Z=Alt
        Vector geo =
            GeographicPositions::CartesianToGeographicCoordinates(it.pos,
                                                                  GeographicPositions::SPHERE);
        // Print Lon (geo.y) first, then Lat (geo.x)
        outFile << geo.y << "\t" << geo.x << "\t" << geo.z << "\t" << it.avgSnrDb << "\t"
...
void
NrRadioGeoEnvironmentMapHelper::PrintGeocentricRemToFile()
{
    NS_LOG_FUNCTION(this);

    if (!m_logGeocentricRem)
    {
        return;
    }

    std::ostringstream oss;
    oss << "nr-rem-" << m_simTag.c_str() << "-ecef.out";
    ...
    // Header: X Y Z SNR SINR RxPwr SIR Lat Lon Alt
    // Format: X \t Y \t Z \t SNR \t SINR \t RxPwr \t SIR \t Lat \t Lon \t Alt
