...
EVP_PKEY*
My_X509_Certificate::generate_rsa_key(unsigned int key_bits)
{
    /*
...
int
My_X509_Certificate::save_pkey(std::string key_file, bool is_private)
{
    /*
...
EVP_PKEY*
My_X509_Certificate::load_key(std::string key_file, bool is_private)
{
    /*
...
X509*
My_X509_Certificate::generate_x509(unsigned int key_bits)
{
    /*
    ...
    X509_NAME_add_entry_by_txt(p_name,
                               "OU",
                               MBSTRING_ASC,
                               (unsigned char*)"My Department",
                               -1,
                               -1,
                               0);
...
X509*
My_X509_Certificate::load_x509_certificate(std::string x509_file)
{
    /*
...
int
My_X509_Certificate::save_x509_certificate(std::string file_name)
{
    /*
