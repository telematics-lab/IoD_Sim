...
class ScenarioConfigurationHelper : public Singleton<ScenarioConfigurationHelper>
{
  public:
    ...
    /**
     * \return Radio Environment Map generation code, 0 for no generation, 1 for generation, 2 for
     * generation with map plot.
     */
     ...
     * simulation start. \return a vector of pairs containing the key and the value extracted from
     * config
     */
