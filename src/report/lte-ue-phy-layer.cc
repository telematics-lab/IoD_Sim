...
{
  static TypeId tid = TypeId ("ns3::LteUEPhyLayer")
    .AddConstructor<LteUEPhyLayer> ()
    .SetParent<ProtocolLayer> ()
    .AddAttribute ("IMSI", "IMSI",
                   StringValue (),
                   MakeStringAccessor (&LteUEPhyLayer::m_imsi),
                   MakeStringChecker ())
    .AddAttribute ("PropagationLossModelDl", "The propagation loss model in downlink",
                   StringValue (),
                   MakeStringAccessor (&LteUEPhyLayer::m_pldl),
                   MakeStringChecker ())
    .AddAttribute ("DlEarfcn", "Downlink E-UTRA Absolute Radio Frequency Channel Number",
                   StringValue (),
                   MakeStringAccessor (&LteUEPhyLayer::m_dlearfnc),
                   MakeStringChecker ())
    .AddAttribute ("DlBandwidth", "Downlink Transmission Bandwidth Configuration in number of Resource Blocks",
                   StringValue (),
                   MakeStringAccessor (&LteUEPhyLayer::m_dlband),
                   MakeStringChecker ())
    .AddAttribute ("PropagationLossModelUl", "The propagation loss model in uplink",
                   StringValue (),
                   MakeStringAccessor (&LteUEPhyLayer::m_plul),
                   MakeStringChecker ())
    .AddAttribute ("UlEarfcn", "Uplink E-UTRA Absolute Radio Frequency Channel Number",
                   StringValue (),
                   MakeStringAccessor (&LteUEPhyLayer::m_ulearfnc),
                   MakeStringChecker ())
    .AddAttribute ("UlBandwidth", "Uplink Transmission Bandwidth Configuration in number of Resource Blocks",
                   StringValue (),
