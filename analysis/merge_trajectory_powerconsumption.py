...
P = ArgumentParser(
    description="Merge trajectory data with power consumption for a given drone."
)
P.add_argument("trajectory_csv_filepath", type=str, help="Trajectory CSV file.")
P.add_argument(
    "power_consumption_csv_filepath", type=str, help="Drone power consumption CSV file."
)
