...
P = ArgumentParser(
    description="Parse LTE Rlc Ul Stats file and output one file per drone/IMSI containing the LTE Cell ID"
)
P.add_argument("rlc_filepath", type=str, help="LTE Rlc Ul Stats file path")
P.add_argument(
    "output_dir", type=str, help="Output directory where new CSV files will be stored"
)
args = P.parse_args()
