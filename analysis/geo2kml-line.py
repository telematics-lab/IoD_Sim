...
if __name__ == "__main__":
    args = parse_args(
        description="""Parse the coordinates in scenario.log and export it in KML format as a line.
                                     The output file is saved in the same directory of the input file."""
    )
