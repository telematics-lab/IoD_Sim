...
latency = {k: to_latency(tx_traces[k], rx_traces[k]) for k in tx_traces.keys()}

# %% Export to MATLAB
lat2matlab = {"NodeID": [], "latency": []}
...
# %%
fig = px.box(latency, labels=dict(value="Latency [s]", variable="GU IP Address"))
fig.show()
# %%
